...
namespace TestDotNetApp.API.Migrations
{
    ...
    [Migration("20200914044602_MessageEntityAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestDotNetApp.API.Models.Like", b =>
                {
            ...
            modelBuilder.Entity("TestDotNetApp.API.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("TestDotNetApp.API.Models.Like", b =>
                {
                    b.HasOne("TestDotNetApp.API.Models.CarModel", "Likee")
                        .WithMany("Likers")
                        .HasForeignKey("LikeeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TestDotNetApp.API.Models.User", "Liker")
                        .WithMany("Likees")
            ...
            modelBuilder.Entity("TestDotNetApp.API.Models.Message", b =>
                {
                    b.HasOne("TestDotNetApp.API.Models.CarModel", "Recipient")
                        .WithMany("MessagesReceived")
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TestDotNetApp.API.Models.User", "Sender")
